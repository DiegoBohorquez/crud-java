...
class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("Deberia devolver null cuando el medico buscado existe pero no esta disponible en la fecha")
    void elegirMedicoAleatorioDisponibleEnLaFechaEscenario1() {
        ...
        var medico = registrarMedico("Medico1", "medico1@gmail.com","12345",Especialidad.CARDIOLOGIA);
        var paciente = registrarPaciente("Paciente1", "paciente1@gmail.com","12347");
